...
UNITE_SENTIMENT_RANKING_PROVIDER = "cardiff_local"
...
UNITE_POST_VIDEO_MAX_UPLOAD_BYTES = int(os.getenv("UNITE_POST_VIDEO_MAX_UPLOAD_BYTES", str(1024 * 1024 * 1024)))
UNITE_POST_VIDEO_MAX_DURATION_SECONDS = int(os.getenv("UNITE_POST_VIDEO_MAX_DURATION_SECONDS", "300"))
UNITE_FFMPEG_PATH = os.getenv("UNITE_FFMPEG_PATH", "").strip()
UNITE_FFPROBE_PATH = os.getenv("UNITE_FFPROBE_PATH", "").strip()
